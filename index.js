...
console.log("\n" + chalk.magentaBright("Welcome - ") + chalk.green(username) +
  "\n\n" + (chalk.blueBright("How well do you know Muskan ? Lets take a quiz to find out.")));
...
answer_one = ['Muskan Yadav', 'Muskan Sharma', 'Muskan Verma', 'Muskan Singh'];
...
answer_six = ['Amity', 'TMU', 'Sharda', 'DU'];
